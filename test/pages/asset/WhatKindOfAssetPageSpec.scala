...
class WhatKindOfAssetPageSpec extends PageBehaviours {
  ...
  "remove money when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(AssetMoneyValuePage(index), num)
        .success
        .value
  ...
  "remove share portfolio data when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        ...
        .success
        .value
        .set(SharePortfolioNamePage(index), str)
        .success
        .value
        .set(SharePortfolioOnStockExchangePage(index), true)
        .success
        .value
        .set(SharePortfolioQuantityInTrustPage(index), num)
        .success
        .value
        .set(SharePortfolioValueInTrustPage(index), num)
        .success
        .value
        .set(ShareCompanyNamePage(index), str)
        .success
        .value
        ...
        .success
        .value
        .set(ShareQuantityInTrustPage(index), num)
        .success
        .value
        .set(ShareValueInTrustPage(index), num)
        .success
        .value
  ...
  "remove property or land when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        ...
        .success
        .value
        .set(PropertyOrLandInternationalAddressPage(index), internationalAddress)
        .success
        .value
        .set(PropertyOrLandDescriptionPage(index), str)
        .success
        .value
        .set(PropertyOrLandTotalValuePage(index), num)
        .success
        .value
        .set(TrustOwnAllThePropertyOrLandPage(index), false)
        .success
        .value
        .set(PropertyLandValueTrustPage(index), num)
        .success
        .value
  ...
  "remove other when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(OtherAssetDescriptionPage(index), str)
        .success
        .value
        .set(OtherAssetValuePage(index), num)
        .success
        .value
  ...
  "remove partnership when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(PartnershipDescriptionPage(index), str)
        .success
        .value
  ...
  "remove business when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(BusinessNamePage(index), str)
        .success
        .value
        .set(BusinessDescriptionPage(index), str)
        .success
        .value
        ...
        .success
        .value
        .set(BusinessValuePage(index), num)
        .success
        .value
  ...
  "remove non-EEA business when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(noneeabusiness.NamePage(index), str)
        .success
        .value
        .set(noneeabusiness.NonUkAddressPage(index), internationalAddress)
        .success
        .value
        .set(noneeabusiness.GoverningCountryPage(index), str)
        .success
        .value
        .set(noneeabusiness.add.StartDatePage(index), date)
        .success
        .value
