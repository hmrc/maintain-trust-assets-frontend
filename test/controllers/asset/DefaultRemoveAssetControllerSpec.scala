...
class DefaultRemoveAssetControllerSpec extends SpecBase with ScalaCheckPropertyChecks {
  ...
  "DefaultRemoveAsset Controller" when {
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      forAll(arbitrary[Boolean]) {
        ...
        redirectLocation(result).value mustEqual routes.AddAssetsController.onPageLoad(fakeDraftId).url
