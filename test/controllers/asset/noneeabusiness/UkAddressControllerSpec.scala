...
class UkAddressControllerSpec extends SpecBase with IndexValidation {
  ...
  private val validAnswer: UKAddress = UKAddress("value 1", "value 2", Some("value 3"), Some("value 4"), "AB1 1AB")

  private lazy val onPageLoadRoute: String = routes.UkAddressController.onPageLoad(index, fakeDraftId).url

  private val baseAnswers: UserAnswers = emptyUserAnswers
    .set(NamePage(index), name).success.value

  "UkAddressController" must {
