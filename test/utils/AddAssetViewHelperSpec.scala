...
class AddAssetViewHelperSpec extends SpecBase {
  ...
  "AddAssetViewHelper" when {
    ...
    ".row" must {
      val nonEeaAsset1         = NonEeaBusinessType(
        None,
        "Non-EEA Business Name1",
        NonUkAddress("", "", None, ""),
        "",
        LocalDate.now,
        None,
      ...
      val nonEeaAsset2         = NonEeaBusinessType(
        None,
        "Non-EEA Business Name2",
        NonUkAddress("", "", None, ""),
        "",
        LocalDate.now,
        None,
      ...
      "generate rows from user answers for non-eea assets" in {
        ...
        rows.complete mustBe List(
          AddRow(
            "Non-EEA Business Name1",
            typeLabel = "Company registered outside UK and EEA (European and Economic Area)",
            changeNonEeaBusinessAssetRoute(0),
            removeNonEeaBusinessAssetRoute(0)
          ),
          AddRow(
            "Non-EEA Business Name2",
            typeLabel = "Company registered outside UK and EEA (European and Economic Area)",
            changeNonEeaBusinessAssetRoute(1),
            removeNonEeaBusinessAssetRoute(1)
          )
        )
      }
      ...
      "generate rows from user answers for property or land assets" in {
        ...
        rows.complete mustBe List(
          AddRow(
            "PropertyOrLand Name1",
            typeLabel = "Property or land",
            changePropertyLandAssetRoute(0),
            removePropertyLandAssetRoute(0)
          ),
          AddRow(
            "PropertyOrLand Name2",
            typeLabel = "Property or land",
            changePropertyLandAssetRoute(1),
            removePropertyLandAssetRoute(1)
          )
        )
      }
      ...
      "generate rows from user answers for partnership assets" in {
        ...
        rows.complete mustBe List(
          AddRow(
            ...
            changePartnershipAssetRoute(0),
            removePartnershipRoute(0)
          ),
          AddRow(
            "Partnership Name2",
            typeLabel = "Partnership",
            changePartnershipAssetRoute(1),
            removePartnershipRoute(1)
          )
        )
      }
