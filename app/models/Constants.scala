...
object Constants {
  ...
  final val MAX_4MLD_ASSETS = {
    MAX_MONEY_ASSETS + MAX_PROPERTY_OR_LAND_ASSETS + MAX_SHARES_ASSETS + MAX_BUSINESS_ASSETS + MAX_PARTNERSHIP_ASSETS + MAX_OTHER_ASSETS
  }

  final val MAX_5MLD_TAXABLE_ASSETS = MAX_4MLD_ASSETS + MAX_NON_EEA_BUSINESS_ASSETS
