...
class PartnershipAssetExtractor extends AssetExtractor[PartnershipType] {
  ...
  override def apply(answers: UserAnswers,
    ...
    super.apply(answers, partnershipType, index)
      .flatMap(_.set(PartnershipDescriptionPage(index), partnershipType.description))
      .flatMap(_.set(PartnershipStartDatePage(index), partnershipType.partnershipStart))
  }
